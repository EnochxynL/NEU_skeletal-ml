"""ST-PGCN: Spatial-Temporal Projection Graph Convolutional Network (PyTorch).

Re-implementation of the TensorFlow version from skeleton-action-recognition.
Interleaves standard ST-GCN blocks with ProjectionGraphConv.
Input:  (N, C, T, V, M)
Output: (N, num_class)
"""
...
from skeletal_dl.model.gcn_blocks import (GraphConvTD, ProjectionGraphConv,
                                          _conv_init, _bn_init)
